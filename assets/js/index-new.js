  ...
  $(document).ready(function(){
    ...
    $('.all-btn').click(function(){
      if ($(this).hasClass('active')) {
          ...
          // Cookies.set("filter", "all", { expires: 14 });
          setTimeout(function() {
    ...
    $('.design-btn').click(function(){
      if ($(this).hasClass('active')) {
          ...
          $(this).addClass('active');
          $(this).removeClass('not-active');
          // Cookies.set("filter", "design", { expires: 14 });
          setTimeout(function() {
    ...
    $('.development-btn').click(function(){
      if ($(this).hasClass('active')) {
          ...
          $(this).addClass('active');
          $(this).removeClass('not-active');
          // Cookies.set("filter", "development", { expires: 14 });
          setTimeout(function() {
            $('.mouse-pos-list-image li, .mouse-pos-list-image-wrap li, .work-tiles li').removeClass('visible');
...
function initScrolltriggerAnimations() {
  ...
  // Scrolltrigger Animation : Span Lines
...
// Scrolltrigger Animation : Span Lines
  if(document.querySelector(".span-lines.animate2")) {
  $(".span-lines.animate2").each(function (index) {
    let triggerElement = $(this);
    let targetElement = $(".span-lines.animate2 .span-line-inner");
...
// Scrolltrigger Animation : Span Lines
  if(document.querySelector(".span-lines.animate3")) {
  $(".span-lines.animate3").each(function (index) {
    let triggerElement = $(this);
    let targetElement = $(".span-lines.animate3 .span-line-inner");
...
// Scrolltrigger Animation : Span Lines
  if(document.querySelector(".span-lines.animate4")) {
  $(".span-lines.animate4").each(function (index) {
    let triggerElement = $(this);
    let targetElement = $(".span-lines.animate4 .span-line-inner");
...
// Scrolltrigger Animation : Span Lines
  if(document.querySelector(".span-lines.animate5")) {
  $(".span-lines.animate5").each(function (index) {
    let triggerElement = $(this);
    let targetElement = $(".span-lines.animate5 .span-line-inner");
...
// Scrolltrigger Animation : Span Lines
  if(document.querySelector(".span-lines.animate6")) {
  $(".span-lines.animate6").each(function (index) {
    let triggerElement = $(this);
    let targetElement = $(".span-lines.animate6 .span-line-inner");
...
// Scrolltrigger Animation : Span Lines
  if(document.querySelector(".span-lines.animate7")) {
  $(".span-lines.animate7").each(function (index) {
    let triggerElement = $(this);
    let targetElement = $(".span-lines.animate7 .span-line-inner");
...
// Scrolltrigger Animation : Span Lines
  if(document.querySelector(".span-lines.animate8")) {
  $(".span-lines.animate8").each(function (index) {
    let triggerElement = $(this);
    let targetElement = $(".span-lines.animate8 .span-line-inner");
...
// Scrolltrigger Animation : Span Lines
  if(document.querySelector(".span-lines.animate1")) {
  $(".span-lines.animate1").each(function (index) {
    let triggerElement = $(this);
    let targetElement = $(".span-lines.animate1 .span-line-inner");
...
// Scrolltrigger Animation : Span Lines
  if(document.querySelector(".span-lines.animate9")) {
  $(".span-lines.animate9").each(function (index) {
    let triggerElement = $(this);
    let targetElement = $(".span-lines.animate9 .span-line-inner");
...
// Scrolltrigger Animation : Span Lines
  if(document.querySelector(".span-lines.animate10")) {
  $(".span-lines.animate10").each(function (index) {
    let triggerElement = $(this);
    let targetElement = $(".span-lines.animate10 .span-line-inner");
...
// Scrolltrigger Animation : Span Lines
  if(document.querySelector(".span-lines.animate11")) {
  $(".span-lines.animate11").each(function (index) {
    let triggerElement = $(this);
    let targetElement = $(".span-lines.animate11 .span-line-inner");
...
// Scrolltrigger Animation : Span Lines
  if(document.querySelector(".span-lines.animate12")) {
  $(".span-lines.animate12").each(function (index) {
    let triggerElement = $(this);
    let targetElement = $(".span-lines.animate12 .span-line-inner");
...
// Scrolltrigger Animation : Span Lines
  if(document.querySelector(".span-lines.animate13")) {
  $(".span-lines.animate13").each(function (index) {
    let triggerElement = $(this);
    let targetElement = $(".span-lines.animate13 .span-line-inner");
...
// Scrolltrigger Animation : Span Lines
  if(document.querySelector(".span-lines.animate14")) {
  $(".span-lines.animate14").each(function (index) {
    let triggerElement = $(this);
    let targetElement = $(".span-lines.animate14 .span-line-inner");
...
// Scrolltrigger Animation : Span Lines
  if(document.querySelector(".span-lines.animate15")) {
  $(".span-lines.animate15").each(function (index) {
    let triggerElement = $(this);
    let targetElement = $(".span-lines.animate15 .span-line-inner");
